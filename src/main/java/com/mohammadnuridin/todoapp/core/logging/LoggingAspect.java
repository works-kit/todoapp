package com.mohammadnuridin.todoapp.core.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.mohammadnuridin.todoapp..api.*Controller.*(..))")
    public void controllerMethods() {
    }

    @Pointcut("execution(* com.mohammadnuridin.todoapp..service.*ServiceImpl.*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.mohammadnuridin.todoapp..repository.*Repository.*(..))")
